...
import com.kochmann.models.embedded.Author;
import com.kochmann.models.embedded.Comment;
import com.kochmann.models.entities.Post;
import com.kochmann.models.entities.User;
import com.kochmann.repositories.PostRepository;
...
public class TestConfig {
	...
	/* permite que o metodo seja executado assim que o contexto da  app for iniciado.
	...
	public void init() {
		...
		User alex = new User (null, "Alex Fred", "alex@gmail.com");
		...
		Post post2 = new Post(null, Instant.parse("2021-02-15T10:05:49Z"), "Bom dia", "Acordei feliz hoje!", new Author(maria));
